...
class RobertaModel(FairseqLanguageModel):
    ...
    def register_classification_head(self, name, num_classes=None, inner_dim=None, **kwargs):
        ...
        self.classification_heads[name] = RobertaClassificationHead(
            ...
            self.args.use_cls_token, # moved here because it was being used as quant_noise_pg_block_size argument
...
class RobertaClassificationHead(nn.Module):
    ...
    def __init__(self, input_dim, inner_dim, num_classes, activation_fn, pooler_dropout, use_cls_token, q_noise=0, qn_block_size=8): # use_cls_token moved before default flags
        super().__init__()
